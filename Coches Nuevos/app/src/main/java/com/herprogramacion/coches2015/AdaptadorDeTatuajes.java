...
public class AdaptadorDeTatuajes extends BaseAdapter {
    private Context context;

    public AdaptadorDeTatuajes(Context context) {
        this.context = context;
    }

    @Override
    public int getCount() {
        return Tatuaje.ITEMS.length;
    }

    @Override
    public Tatuaje getItem(int position) {
        return Tatuaje.ITEMS[position];
    }
    ...
    public View getView(int position, View view, ViewGroup viewGroup) {
        ...
        final Tatuaje item = getItem(position);
